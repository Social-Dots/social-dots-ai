        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-12 pb-12">
          <div className="lg:col-span-2">
            ...
            <div className="flex space-x-4">
              ...
              <a href="#" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full bg-gray-800 flex items-center justify-center text-white transition-all hover:bg-pink-600 hover:text-white hover:scale-105">
              ...
              <a href="#" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full bg-gray-800 flex items-center justify-center text-white transition-all hover:bg-red-600 hover:text-white hover:scale-105">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="border-l border-gray-700 pl-8">
            ...
            <ul className="space-y-3">
              ...
              <li><Link to="/careers" className="text-white hover:text-blue-400 transition-colors">Careers</Link></li>
